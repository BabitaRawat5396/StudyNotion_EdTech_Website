...
const EnrolledCoursesTable = ({enrolledCourses,setEnrolledCourses}) => {
  ...
  return (
    <div className='border border-richblack-700 rounded-2xl my-10 mx-8'>
              <Table>
                  ...
                  enrolledCourses.map( (course,index) => (
                    <Tr key={index}
                      ...
                      <Td className="flex items-center flex-1 gap-x-4"
                        ...
                        >
                        <img src={course?.thumbnail} alt={`${course?.courseName}`} className="h-[120px] w-[200px] rounded-lg object-cover"/>
                      ...
                      <Td>
                          ...
                          />
                        {
                          ...
                          (
                            <>
                              <div className='absolute top-4 right-36 lg:top-auto lg:right-7 lg:bottom-[5.5rem] bg-richblack-700 h-5 w-5 rotate-45'></div>
                              <div className='absolute lg:right-4 lg:bottom-8 bg-richblack-700 p-3 rounded-2xl text-sm flex flex-col gap-2'>
                                <div 
