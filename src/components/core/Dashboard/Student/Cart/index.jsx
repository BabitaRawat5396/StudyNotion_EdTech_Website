...
export default function Cart() {
    ...
    return (
        <div className=" text-richblack-100 flex flex-col gap-8 h-full">
            <p className=" text-sm text-richblack-300 mt-6 pl-8"> <Link to='/'>Home</Link>  / Dashboard  / <span className=" text-yellow-100">Wishlist</span></p>
            {total > 0 
            ? (
