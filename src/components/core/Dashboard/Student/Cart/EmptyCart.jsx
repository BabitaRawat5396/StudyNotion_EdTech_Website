...
const EmptyCart = () => {
  return (
    <div className="empty-cart mx-auto text-center font-maison-neue font-light">
      ...
      <h3 className='text-2xl leading-2rem font-semibold mt-8'>Your shopping cart is empty</h3>
      <p className='text-gray-500 text-base leading-6 max-w-80 mx-auto mt-5'>Before proceed to checkout you must add some courses to your shopping cart. You will find a lot of interesting courses on our "Shop" page.</p>
    </div>
  )
}
